...
import (
	...
	enovoy "github.com/wso2/k8s-api-operator/api-operator/pkg/envoy/pkg/oasparser/envoyCodegen"
	"github.com/wso2/k8s-api-operator/api-operator/pkg/envoy/pkg/oasparser/models/envoy"
	swgger "github.com/wso2/k8s-api-operator/api-operator/pkg/envoy/pkg/oasparser/swaggerOperator"
 ...
 */
func GetProductionSources(swaggerDefs *map[string]string) ([]types.Resource, []types.Resource, []types.Resource, []types.Resource) {
	logger.LoggerOasparser.Debug("debug check....................")
	mgwSwaggers, err := swgger.GenerateMgwSwagger(swaggerDefs)
	if err != nil {
 ...
 */
func GetSandboxSources(swaggerCms *map[string]string) ([]types.Resource, []types.Resource, []types.Resource, []types.Resource) {
	mgwSwaggers, err := swgger.GenerateMgwSwagger(swaggerCms)
	if err != nil {
		logger.LoggerOasparser.Fatal("Error Generating mgwSwagger struct:", err)
	}
